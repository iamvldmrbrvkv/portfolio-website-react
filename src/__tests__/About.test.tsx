...
describe("About", () => {
  ...
  it("renders profile image", () => {
    ...
    const profileImage = screen.getByAltText(
      "Vladimir Borovikov with laptop Memoji",
    );
  ...
  it("displays correct career information", () => {
    ...
    expect(
      screen.getByText(/In the past I was a musician and art worker/),
    ).toBeInTheDocument();
    expect(
      screen.getByText(/watching coding dreams when I'm sleeping/),
    ).toBeInTheDocument();
  });
});
