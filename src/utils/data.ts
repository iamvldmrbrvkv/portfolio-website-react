...
export const projects: Project[] = [
  {
    title: "Jammming",
    description:
      "The app created using knowledge of React components, passing state, and requests with the Spotify API to build a website that allows users to search the Spotify library, create a custom playlist, then save it to their Spotify account.",
  ...
  },
  {
    title: "Test App",
    description:
      "Interactive test application with randomized questions and answers, progress tracking, and results visualization. Built using React, Vite, Redux Toolkit for state management, and MSW for API mocking.",
  ...
  },
  {
    ...
    description:
      "Interactive web application for creating and editing shapes on a canvas. Features include adding, moving, resizing shapes, changing colors, canvas zoom and pan functionality. Built with TypeScript, React, React-Konva, and Material-UI.",
  ...
  },
  {
    ...
    description:
      "Custom web component for file uploading with drag-and-drop support, progress tracking, and error handling. Supports .txt, .json, and .csv files up to 1KB. Built with vanilla JavaScript and Shadow DOM.",
